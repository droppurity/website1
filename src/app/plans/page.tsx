...
export default function DroppurityPlansPage() {
  ...
  return (
    <div className={`min-h-screen flex flex-col items-center ${themeAccentClass} py-6 sm:py-12 px-4`}>
      ...
      <main className="w-full max-w-6xl mx-auto">
        <section className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card rounded-xl shadow-lg">
        ...
        <section>
          <h2 className="text-2xl sm:text-3xl font-semibold font-headline text-center mb-6 sm:mb-8 text-foreground">
            3. Pick Your Plan
          </h2>
